	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false, ?isDebug:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf-pixel':
				...
				flipX = true;
			case 'barb':
				frames = Paths.getSparrowAtlas("characters/Idle");
				...
				otherFrames.push(new Character(x,y,"barb-left"));
				otherFrames.push(new Character(x,y,"barb-right"));
				otherFrames.push(new Character(x,y,"barb-up"));
				otherFrames.push(new Character(x,y,"barb-down"));
			...
			case 'barb-right':
				...
				frames = Paths.getSparrowAtlas("characters/Right");

				animation.addByPrefix("idle","Barbarian RIGHT animation", 24, false);

				addOffset('idle',293,-77);
			...
			case 'barb-left':
				...
				frames = Paths.getSparrowAtlas("characters/Left");

				animation.addByPrefix("idle","LEFT pose barbarian", 24, false);


				addOffset('idle',998,-230);
				...
				trace('left');
			case 'barb-down':
				frames = Paths.getSparrowAtlas("characters/Down");

				animation.addByPrefix("idle","DOWN", 24, false);

				addOffset('idle',417,-257);

				playAnim('idle');
				trace('down');
			case 'barb-up':
				frames = Paths.getSparrowAtlas("characters/Up");

				animation.addByPrefix("idle","UP barbarian", 24, false);

				addOffset('idle',420,-150);
